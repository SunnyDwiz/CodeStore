...
-- =============================================
CREATE PROCEDURE Sp_InsertEmpData
(
...
BEGIN
	...
	SET NOCOUNT ON;
	Insert into tbEmpDetails(Name, Email, EState, City, Phone, UserName, EPassword, Gender, Skill, Religion, IsActive, RoleId) values(  @EmpName, @Email,  @EState,
	 @City, @Phone, @UserName,  @EPassword, @Gender,  @Skill,
	 @Religion,  @IsActive, @RoleId )
